...
\label{tab:MItable}
\centering
\input{Tables/MItable}
\end{table}
\addtocounter{table}{-1}
\begin{table}[H]
\caption{Tien woorden met de hoogste Mutual Information per partij \emph{(Vervolg)}}
\centering
\input{Tables/MItable2}
\end{table}

\footnotetext{{Ten behoeve van de leesbaarheid is voor elke gestemde woord het meest frequente ongestemde woord gekozen}}
