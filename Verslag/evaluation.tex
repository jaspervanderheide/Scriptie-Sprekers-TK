...
In tabel \ref{fig:distanceerror} is de error te zien ten opzichte van de afstand op de links/rechts schaal.
\begin{figure}[H]
  \centering
    \includegraphics[width=0.50\paperwidth]{Verslag/Tables/Ideology.png}
\caption{Error ten opzichte van de afstand op de links/rechts schaal van twee partijen. Gebaseerd op 100 classificaties met verschillende test en train set. De pearson correlatie is 0.09 en de p-waarde \num{2.39e-20}.}
\label{fig:distanceerror}
\end{figure}
De correlatie is met daarmee significant op het significantieniveau van 0.05, maar wel positief. Uit deelvraag 3 bleek dat de error binnen oppositie of regering significant afweek van de error tussen regering en oppositie. Dit effect lijkt ook zichtbaar in tabel \ref{fig:distanceerror}. Daarom wordt er in tabel \ref{tab:pearson} ook gekeken naar de correlatie tussen afstand op de links/rechts schaal en error binnen oppositie en tussen regerings- en oppositiepartij.
