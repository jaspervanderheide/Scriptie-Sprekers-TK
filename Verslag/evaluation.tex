...
\begin{figure}[H]
    \centering
    \hspace*{-1in}
    \subfloat[label 1]{{\includegraphics[width=9cm]{Verslag/Tables/Regering.png} }}%
    \subfloat[label 2]{{\includegraphics[width=9cm]{Verslag/Tables/Oppositie.png} }}\quad
    \subfloat[label 3]{{\includegraphics[width=9cm]{Verslag/Tables/Mix.png} }}%
    \subfloat[label 4]{{\includegraphics[width=9cm]{Verslag/Tables/Totaal.png} }}%
